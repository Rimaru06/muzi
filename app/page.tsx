...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      <Appbar />
      <main className="flex justify-center items-center py-12 md:py-24 lg:py-32">
      ...
      <section className="flex justify-center items-center w-full py-12 md:py-24 lg:py-32 bg-gray-800 bg-opacity-50">
        <div className="container px-4 md:px-6">
